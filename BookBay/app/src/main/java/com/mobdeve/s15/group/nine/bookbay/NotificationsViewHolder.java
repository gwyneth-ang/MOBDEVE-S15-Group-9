...
public class NotificationsViewHolder extends RecyclerView.ViewHolder {
    ...
    public void bindData(Books_sell book) {
        ...
        this.tvSellerName_notifLayout.setText(book.getOwnerID());
        this.tvBookTitle_notifLayout.setText(book.getBookTitle());
        this.tvTimePassed_notifLayout.setText(book.getNotificationDateTime().toString());

        if (book.getStatus().equals("CONFIRMED")) {
            this.tvStatusBook_notifLayout.setText("Woohoo! Your purchase of " + book.getBookTitle() + " has been approved by the seller! You will be receiving this book by your doorstep soon");
            this.ibButton_notifLayout.setImageResource(R.drawable.check_mark);
        } else {
            this.tvStatusBook_notifLayout.setText("I’m sorry, your purchase of " + book.getBookTitle() + "has been denied by the seller. Check our Thrift Store for more book options.");
